...
public class AddFraldaDialog {
    ...
    public AddFraldaDialog(Context context) {
    ...
    public AlertDialog setDialog(final ListView listView) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                TaskSingleton.getInstance().getTasks().add(new Task(Task.FRALDA_SUJA, time, "", "", etAnnotations.getText().toString(),""));
