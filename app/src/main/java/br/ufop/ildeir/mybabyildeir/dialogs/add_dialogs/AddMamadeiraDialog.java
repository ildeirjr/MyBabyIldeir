...
public class AddMamadeiraDialog {
    ...
    public AddMamadeiraDialog(Context context) {
    ...
    public AlertDialog setDialog(final ListView listView) {
        ...
        view = li.inflate(R.layout.mamadeira_layout, null);

        tvDate = view.findViewById(R.id.mamadeiraDate);
        tvStartTime = view.findViewById(R.id.mamadeiraTime);
        etQtd = view.findViewById(R.id.mamadeiraQtd);
        etAnnotations = view.findViewById(R.id.mamadeiraAnnotations);
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                TaskSingleton.getInstance().getTasks().add(new Task(Task.MAMADEIRAS, time, "", etQtd.getText().toString(), etAnnotations.getText().toString(),""));
