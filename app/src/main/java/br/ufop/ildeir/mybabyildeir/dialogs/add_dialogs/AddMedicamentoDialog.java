...
public class AddMedicamentoDialog {
    ...
    public AddMedicamentoDialog(Context context) {
    ...
    public AlertDialog setDialog(final ListView listView) {
        ...
        view = li.inflate(R.layout.medicamento_layout, null);

        tvDate = view.findViewById(R.id.medicamentoDate);
        tvStartTime = view.findViewById(R.id.medicamentoTime);
        etNome = view.findViewById(R.id.medicamentoNome);
        etQtd = view.findViewById(R.id.medicamentoQtd);
        etAnnotations = view.findViewById(R.id.medicamentoAnnotations);

        final DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
        final DateFormat timeFormat = new SimpleDateFormat("HH:mm");

        tvDate.setText(dateFormat.format(time.getTime()));
        tvStartTime.setText(timeFormat.format(time.getTime()));
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                TaskSingleton.getInstance().getTasks().add(new Task(Task.MEDICAMENTOS, time, "", etQtd.getText().toString(), etAnnotations.getText().toString(),etNome.getText().toString()));
