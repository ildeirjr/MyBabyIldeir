...
public class AddOutrosDialog {
    ...
    public AddOutrosDialog(Context context) {
    ...
    public AlertDialog setDialog(final ListView listView) {
        ...
        builder.setTitle("Outro");
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                TaskSingleton.getInstance().getTasks().add(new Task(Task.OUTROS, time, "", "", etAnnotations.getText().toString(),""));
