...
public class EditMedicamentoDialog {
    ...
    public EditMedicamentoDialog(Context context, int taskIndex) {
    ...
    public AlertDialog setDialog(final ListView listView) {
        ...
        etNome.setText(task.getMedicationName());
        etQtd.setText(task.getQtd());
        ...
        builder.setTitle("Mamadeira");
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                task.setTime(startTime);
                task.setMedicationName(etNome.getText().toString());
                task.setQtd(etQtd.getText().toString());
