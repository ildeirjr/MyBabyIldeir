...
public class AddMamadaDialog {
    ...
    public AddMamadaDialog(Context context){
    ...
    public AlertDialog setDialog(final ListView listView){
        ...
        view = li.inflate(R.layout.mamada_layout, null);

        tvDate = view.findViewById(R.id.mamadaDate);
        tvTime = view.findViewById(R.id.mamadaStartTime);
        etDuration = view.findViewById(R.id.mamadaDuration);
        etAnnotations = view.findViewById(R.id.mamadaAnnotations);
        ...
        builder.setTitle("Mamada");
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                Log.e("teste",timeFormat.format(time.getTime()));
                TaskSingleton.getInstance().getTasks().add(new Task(Task.MAMADA, time, etDuration.getText().toString(), "", etAnnotations.getText().toString(),""));
